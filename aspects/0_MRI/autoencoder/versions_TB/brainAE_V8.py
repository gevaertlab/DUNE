...
class convAE(nn.Module):
    def __init__(self, in_c, out_c, num_feat, num_blocks):
        ...
        self.norm = torchvision.transforms.Normalize((0.5, 0.5,), (0.5, 0.5,))
    ...
    def decoder(self, x, indexes, shapes):
        ...
        # decoded_img = self.norm(decoded_img)
    ...
    for idx, (imgs, caseid) in enumerate(testLoader):
        try:
            ...
            with torch.no_grad():
                ...
                psnr = psnr_measurer(outputs, batch_images)
                psnr_list.append(psnr.item())
                ssim = ssim_measurer(outputs, batch_images)
