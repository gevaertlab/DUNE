...
INPUT = path.join(ROOT_DIR, "data/MR/REMBRANDTVerified") 
OUTPUT = path.join(ROOT_DIR, "data/MR/REMBRANDT/") 
...
if __name__=='__main__':
    ...
    for _, case in enumerate(cases):
        ...
        sequences = ["t1-post_pre_bcorr_brain.nii","flair_t1_bcorr_brain.nii"]
        newnames = [f"{case[:-1]}_t1Gd.nii", f"{case[:-1]}_flair.nii"]
