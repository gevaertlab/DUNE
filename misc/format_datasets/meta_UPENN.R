...
varlist <- fread("/home/tbarba/projects/MultiModalBrainSurvival/data/metadata/UPENN/0-variable_list.csv")
...
raw <- fread("/home/tbarba/projects/MultiModalBrainSurvival/data/metadata/UPENN/UPENN-GBM_clinical_info_v1.0.csv", na.strings = "Not Available")
...
fwrite(normalized,
    file = "/home/tbarba/projects/MultiModalBrainSurvival/data/metadata/UPENN/0-UPENN_metadata_encoded.csv"
)
